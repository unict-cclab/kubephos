...
func TestDiscoveryUsesOnlyGetAndProtectsResources(t *testing.T) {
	...
	spec := json.RawMessage(`{"endpoint":"` + server.URL + `","credentialRef":"cred_test","verifyTLS":false,"vmidStart":9000,"addressStart":"10.10.0.10","prefixLength":24,"gateway":"10.10.0.1","dnsServer":"1.1.1.1"}`)
...
func TestValidateNetworkProfileRejectsUnusablePool(t *testing.T) {
	for _, spec := range []Spec{
		{VMIDStart: 9000, AddressStart: "invalid", PrefixLength: 24, Gateway: "10.10.0.1", DNSServer: "1.1.1.1"},
		{VMIDStart: 9000, AddressStart: "10.10.0.1", PrefixLength: 24, Gateway: "10.10.0.1", DNSServer: "1.1.1.1"},
		{VMIDStart: 9000, AddressStart: "10.10.0.10", PrefixLength: 24, Gateway: "10.11.0.1", DNSServer: "1.1.1.1"},
	} {
