...
import (
	...
	secondaryscheduler "kubephos.dev/kubephos/plugins/secondary-scheduler/runtime"
)
...
func run() error {
	...
	var invocation secondaryscheduler.Invocation
	if err := json.Unmarshal(payload, &invocation); err != nil {
		return err
	}
	plugin := secondaryscheduler.Plugin{}
