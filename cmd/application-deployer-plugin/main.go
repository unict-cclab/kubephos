...
import (
	...
	applicationdeployer "kubephos.dev/kubephos/plugins/application-deployer/runtime"
)
...
func run() error {
	...
	var invocation applicationdeployer.Invocation
	if err := json.Unmarshal(payload, &invocation); err != nil {
		return err
	}
	plugin := applicationdeployer.Plugin{}
